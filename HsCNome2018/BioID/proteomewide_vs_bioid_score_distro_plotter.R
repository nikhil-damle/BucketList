...
{
 #ransam<-read.table(paste("mean10000X_PxPSSM_topScorer_distro_frm_REST_o_HsProteome_IUme",i,sep=""))
 #ransam<-read.table(paste("mean10000X_LxPSSM_topScorer_distro_frm_REST_o_HsProteome_IUme",i,sep=""))

 ransam<-read.table(paste("mean1000X_PxPSSM_topScorer_distro_frm_REST_o_HsProteome_IUme",i,sep=""))
 #ransam<-read.table(paste("mean1000X_LxPSSM_topScorer_distro_frm_REST_o_HsProteome_IUme",i,sep=""))
 ...
 bioid<-read.table(paste("SnD_highest_scoring_uniq12mer_IUme",i,sep=""))
 #bioid<-read.table(paste("SnD_highest_scoring_uniq7mer_IUme",i,sep=""))
 ...
 pdf(paste("bioID_vs_rest_o_proteome_PxPSSM_IUme",i,"_shift_hist.pdf",sep=""),width=6,height=6,useDingbats=F)
 #pdf(paste("bioID_vs_rest_o_proteome_LxPSSM_IUme",i,"_shift_hist.pdf",sep=""),width=6,height=6,useDingbats=F)
 ...
 #pdf(paste("bioID_vs_rest_o_proteome_PxPSSM_IUme",i,"_shift_density.pdf",sep=""),width=6,height=6,useDingbats=F)
 #pdf(paste("bioID_vs_rest_o_proteome_LxPSSM_IUme",i,"_shift_density.pdf",sep=""),width=6,height=6,useDingbats=F)
